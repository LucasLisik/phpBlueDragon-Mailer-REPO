...
echo '<h1><img src="'.base_url('library/hemailedit.png').'" width="32" height="32" style="vertical-align: middle;" /> '.$this->lang->line('groupv_edith3').'</h1>';

echo '<div class="BorderDiv">';

if($EmailAdded)
{
    echo '<div class="goodAction">'.$this->lang->line('groupv_updated3').'</div>';	
}
...
echo form_open('edit-email/'.$IdOfContent.'/'.$IdOfContentEmail);
...
$SubmitButton = array('name' => 'zaloguj', 'value' => $this->lang->line('groupv_updatesubmit3'), 'style' => 'width: 100%;');
